...
class ServerModel with ChangeNotifier {
  ...
  // Modelo para gerenciar técnicos confiáveis
  final _trustedTechnicianModel = TrustedTechnicianModel();
  
  // Rastreador de intenção de lembrar técnico (por sessionId/peerId)
  ...
  ServerModel(this.parent) {
    ...
    // Carregar lista de técnicos confiáveis
  ...
  void showLoginDialog(Client client) {
    // Verificar se este técnico é confiável e deve ser auto-aprovado
  ...
  void sendLoginResponse(Client client, bool res) async {
    if (res) {
      ...
      // Se o usuário marcou para lembrar este técnico, salve-o
  ...
  /// Define se o usuário quer lembrar deste técnico
  void setRememberTechnician(String peerId, bool remember) {
    _rememberTechnicianFlags[peerId] = remember;
  }

  /// Verifica se deve lembrar deste técnico
