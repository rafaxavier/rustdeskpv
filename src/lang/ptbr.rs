...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Check the checkbox when accepting a connection to add to trusted list", "Marque a caixa ao aceitar uma conexão para adicionar à lista de confiáveis"),
        ("Remove Trusted Technician", "Remover Técnico Confiável"),
    ...
    ("Hide connection dialog", "Ocultar diálogo de conexão"),
